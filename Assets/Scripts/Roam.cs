/*  File:       Roam
    Purpose:    this file may have been an attempt at making the Roam
                functionality, which most of the GameObjects in this game have
                more generic. Assume the intention was to refactor Objects to
                use this instead of implementing their own Roam functions.
                Unfortunately, the authors did not provide any comments or
                complete what they were trying to do, and class is only as
                useful as its documentation. Perhaps a future group can take
                a look at this and determine what it's doing and how it could
                be applied to other Game Objects
                RPW
*/
